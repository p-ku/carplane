...
public class CarCam : Camera
{
  ...
  internal Transform PrevLocalTransform;
  ...
  public override void _PhysicsProcess(float delta)
  {
	...
	velCam.Far = GlobalTransform.origin.Length() + vars.planet_radius * 0.5f;
	// Near = GlobalTransform.origin.Length() - vars.planet_radius - 3;
	velCam.Near = Mathf.Tan(vars.FovHalfRad.y) * (GlobalTransform.origin.Length() - vars.planet_radius - 4);
